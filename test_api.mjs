...
async function main() {
  ...
  // /auth/me
  console.log("=== Me ===");
  r = await fetch(`${BASE}/api/auth/me`, { headers });
  data = await r.json();
  console.log(`Status: ${r.status}`);
  console.log(`Response: ${JSON.stringify(data)}`);
  console.log();
  ...
  r = await fetch(`${BASE}/api/entries/start`, {
    method: "POST",
  ...
  r = await fetch(`${BASE}/api/entries/active`, { headers });
  data = await r.json();
  console.log(`Status: ${r.status}`);
  console.log(`Response: ${JSON.stringify(data)}`);
  console.log();
  ...
  r = await fetch(`${BASE}/api/entries/stop`, { method: "POST", headers });
  data = await r.json();
  console.log(`Status: ${r.status}`);
  console.log(`Response: ${JSON.stringify(data)}`);
  console.log();
  ...
  r = await fetch(`${BASE}/api/entries?date=${today}`, { headers });
  data = await r.json();
  console.log(`Status: ${r.status}`);
  console.log(`Response: ${JSON.stringify(data)}`);
  console.log();
  ...
  // Stats
  console.log("=== Stats ===");
  r = await fetch(`${BASE}/api/stats?from=${today}&to=${today}`, { headers });
  data = await r.json();
  console.log(`Status: ${r.status}`);
  console.log(`Response: ${JSON.stringify(data)}`);
  console.log();
  ...
  r = await fetch(`${BASE}/api/auth/me`, { headers: { "Authorization": "Bearer invalidtoken" } });
  data = await r.json();
  console.log(`Status: ${r.status}`);
  console.log(`Response: ${JSON.stringify(data)}`);
  console.log();
  ...
  r = await fetch(`${BASE}/api/entries/99999`, {
    method: "PATCH",
    headers: { ...headers, "Content-Type": "application/json" },
  ...
  r = await fetch(`${BASE}/api/entries/${entryId}`, { method: "DELETE", headers });
  console.log(`Status: ${r.status}`);
  console.log();
  ...
  // Stop
  await fetch(`${BASE}/api/entries/stop`, { method: "POST", headers });
